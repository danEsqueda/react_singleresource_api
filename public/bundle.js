  ...
  render: function() {
    return (
      React.createElement("main", null, 
        React.createElement("h1", null, "Welcome to Running Stats"), 
        React.createElement(RunContainer, null)
      )
    )
  }
})
...
},{"./components/runContainer":3,"react":160}],2:[function(require,module,exports){
var React = require('react')

var NewRun = React.createClass({displayName: "NewRun",
  getInitialState: function() {
    return {
      newName: '',
      newDistance: 0,
  ...
  render: function() {
    return (
      React.createElement("section", null, 
        React.createElement("h4", null, "Add a new run here "), 
        React.createElement("p", null, "Route Name: ", this.state.newName), 
        React.createElement("p", null, "Distance: ", this.state.newDistance), 
        React.createElement("p", null, "Duration: ", this.state.newHrs, ":", this.state.newMins, ":", this.state.newSec), 
        "Route Name:", 
        React.createElement("input", {type: "text", value: this.state.newName, onChange: this.updateNewName}), 
        "Distance in miles:", 
        React.createElement("input", {type: "number", value: this.state.newDistance, onChange: this.updateNewDistance}), 
        "Duration:", 
        React.createElement("input", {type: "number", max: "24", value: this.state.newHrs, onChange: this.updateNewHrs}), 
        ":", 
        React.createElement("input", {type: "number", max: "59", value: this.state.newMins, onChange: this.updateNewMins}), 
        ":", 
        React.createElement("input", {type: "number", max: "59", value: this.state.newSec, onChange: this.updateNewSec}), 
        React.createElement("button", {onClick: this.handleAddNew}, " Add Run ")
      )
    )
  }
})
...
var RunContainer = React.createClass({displayName: "RunContainer",
  getInitialState: function() {
    return {
      runs: [
        {name: 'test route 1', distance: 3, hrs: 0, mins: 28, sec: 15},
  ...
  render: function() {
    return (
      React.createElement("main", null, 
        React.createElement("h1", null, "My Run Tracker"), 
        React.createElement(NewRun, {addRun: this.addRun}), 
        React.createElement(RunList, {runs: this.state.runs})
      )
    )
  }
})
...
},{"./newRun":2,"./runList":4,"react":160}],4:[function(require,module,exports){
var React = require('react')
  ...
  render: function() {
    return (
      React.createElement("div", null, 
        ...
        React.createElement("p", null, this.props.distance, " miles"), 
        React.createElement("p", null, this.props.hrs, ":", this.props.mins, ":", this.props.sec)
      )
    )
  }
})

var RunList = React.createClass({displayName: "RunList",
  render: function() {
    var runs = this.props.runs.map(function(run) {
      return React.createElement(Run, {name: run.name, distance: run.distance, hrs: run.hrs, mins: run.mins, sec: run.sec})
    })
    return (
      React.createElement("section", null, 
        React.createElement("h2", null, "My Runs:"), 
         runs 
      )
    )
  }
